        ...
        <nav className="bg-white border-gray-200 w-full mt-6">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <div className='w-[40px] h-[40px] flex bg-[#458FF6] rounded-[50%] text-center justify-center items-center text-xl font-mulish font-black text-[#fff]'>T</div>
                    <span className="self-center text-2xl font-semibold text-gray-900  font-mulish">Trafalgar</span>
                </a>
